# с 03.02.2023 папка перенесена в ветку GeekBrainsScool -> Probability_ theory_mathematical_statistics, обнавления будут там. В последствии репозиторий будет удален.
